...
<div class="container-fluid py-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        <div class="d-flex align-items-center gap-2">
            ...
            {{-- CARTA DE ACEPTACIÓN --}}
            <a href="{{ route('estudiantes.cartaAceptacion', $estudiante->id) }}"
               class="btn btn-success">
                <i class="fas fa-file-pdf me-1"></i> Carta de Aceptación
            </a>

            {{-- CARTA DE TÉRMINO --}}
            @if($estudiante->horas_actuales >= $estudiante->horas_requeridas && $estudiante->horas_requeridas > 0)
                <a href="{{ route('estudiantes.cartaTermino', $estudiante->id) }}"
                   class="btn btn-primary">
                    <i class="fas fa-file-pdf me-1"></i> Carta de Término
                </a>
            @else
                <button class="btn btn-primary" disabled>
                    <i class="fas fa-lock me-1"></i> Carta de Término
                </button>
            @endif
            ...
            <div class="mb-4">
                ...
                @if($act >= $req && $req > 0)
                    <div class="alert alert-success mt-3">
                        El estudiante ya completó sus horas requeridas.
                    </div>
                @endif
            </div>
